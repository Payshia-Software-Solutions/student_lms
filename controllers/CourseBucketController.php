...
class CourseBucketController
{
    ...
    public function createRecord()
    {
        ...
        if ($newId) {
            ...
            echo json_encode(['status' => 'success', 'message' => 'Course bucket created successfully', 'data' => ['id' => $newId]]);
        } else {
    ...
    public function updateRecord($id)
    {
        ...
        if ($this->courseBucket->update($id, $data)) {
            echo json_encode(['status' => 'success', 'message' => 'Course bucket updated successfully']);
        } else {
            http_response_code(500);
